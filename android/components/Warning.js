      ...
      <View >
        <Modal
         ...
         <View style={styles.popup}>
          <View>
            <Text style={{color: 'white', textAlign: 'center', fontSize: 30, fontWeight: 'bold'}}>Warning!</Text>
            <Text style={{color: 'white', textAlign: 'center', fontSize: 30}}>This food contains ingredients that you may want to avoid!</Text>
